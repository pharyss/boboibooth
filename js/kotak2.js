...
// Tampilkan hasil dalam bentuk polaroid
    ...
    for (let i = 0; i < photoElements.length; i++) {
      ...
      await new Promise((res) => {
        ...
        image.onload = () => {
          ...
          tempCtx.fillRect(0, 0, width, height); // Latar putih
          tempCtx.drawImage(image, 10, 10, width - 20, height - 20); // Gambar lebih penuh, tanpa caption
